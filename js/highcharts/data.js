        ...
        g.extend(A.prototype, {
            ...
            parseGoogleSpreadsheet: function () {
                ...
                e &&
                    (delete d.googleSpreadsheetKey, a(function (a) {
                        ...
                        for (r = 0; r < e; r++) c = a[r], g = c.gs$cell.row - 1, n = c.gs$cell.col - 1, n >= h && n <= m && g >= k && g <= q && (p = c.gs$cell || c.content, c = null, p.numericValue ? c = 0 <= p.$t.indexOf("/") || 0 <= p.$t.indexOf("-") ? p.$t : 0 < p.$t.indexOf("%") ? 100 * parseFloat(p.numericValue) : parseFloat(p.numericValue) : p.$t && p.$t.length && (c =
                            p.$t), d[n - h][g - k] = c);
            ...
            parseColumn: function (a, b) {
                var d = this.rawColumns,
                    e = this.columns,
                    f = a.length,
                    c, k, g, h, m = this.firstRowAsNames,
                    n = -1 !== this.valueCount.xColumns.indexOf(b),
                    p, t = [],
                    u = this.chartOptions,
                    v, x = (this.options.columnTypes || [])[b],
                ...
                if (n && v && this.options.sort)
                    for (b = 0; b < e.length; b++) e[b].reverse(), m && e[b].unshift(e[b].pop())
            },
            dateFormats: {
                "YYYY/mm/dd": {
            ...
            parseDate: function (a) {
                var b = this.options.parseDate,
                    d, e, f = this.options.dateFormat || this.dateFormat,
                    c;
                if (b) d = b(a);
                else if ("string" === typeof a) {
                    if (f)(b = this.dateFormats[f]) || (b = this.dateFormats["YYYY/mm/dd"]), (c = a.match(b.regex)) && (d = b.parser(c));
                    else
            ...
            rowsToColumns: function (a) {
                ...
                if (a)
                    for (c = [], d = a.length, b = 0; b < d; b++)
                        for (f = a[b].length, e = 0; e < f; e++) c[e] || (c[e] = []), c[e][b] = a[b][e];
                return c
            },
            getData: function () {
            ...
            getFreeIndexes: function (a, b) {
                ...
                for (a = 0; a < b.length; a += 1)
                    for (c = b[a].getReferencedColumnIndexes(), d = 0; d < c.length; d += 1) e[c[d]] = !1;
            ...
            complete: function () {
                ...
                if (d.complete || d.afterComplete) {
                    ...
                    for (; 0 < f.length;) {
                        ...
                        c = f.indexOf(0); - 1 !== c && f.splice(c, 1);
                    ...
                    if ("category" === b)
                        for (c = 0; c < g.length; c++)
                            for (h = g[c], f = 0; f < h.readers.length; f++) "x" ===
                ...
                afterComplete: function (a) {
                    ...
                    if (d.hasOwnProperty("series"))
                        if ("object" === typeof d.series)
                            for (c = Math.max(d.series.length, a && a.series ? a.series.length : 0); c--;) f = d.series[c] || {}, d.series[c] = z(f, a && a.series ? a.series[c] : {});
